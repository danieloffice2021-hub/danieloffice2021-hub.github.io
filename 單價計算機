...
<div class="container">
  ...
  <div class="card">
    <div class="form-group"><label>長</label><input type="number" id="length" value="0"></div>
    <div class="form-group"><label>寬</label><input type="number" id="width" value="0"></div>
    <div class="form-group"><label>規格</label><input type="text" id="spec" placeholder="例如：全紙"></div>
    <div class="form-group"><label>盎司 (Oz)</label><input type="number" id="ounce" value="0"></div>
    <div class="form-group"><label>客訂張數</label><input type="number" id="customSheet" value="0"></div>
    <div class="form-group"><label>噸價 (KG)</label><input type="number" id="tonPrice" value="0"></div>
    <div class="form-group"><label>各式加工費 (一噸)</label><input type="number" id="procTon" value="0"></div>
    <div class="form-group"><label>基本加工費 (一批)</label><input type="number" id="procBatch" value="0"></div>
    <div class="form-group"><label>裁工 (單張)</label><input type="number" id="cutSheet" value="0"></div>
    <div class="form-group"><label>裁工 (一批)</label><input type="number" id="cutBatch" value="0"></div>
...
<script>
  ...
  function calculate() {
    ...
    // 計算總和，並避免 JavaScript 浮點數精度問題 (例如 1.1 + 0.2 = 1.3000000000000003)
